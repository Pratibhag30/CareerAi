...
export default function Recommendations() {
 ...
 return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-indigo-50">
      ...
      <div className="flex flex-col items-center justify-start pt-24 px-6 md:px-10">
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-8 py-3 rounded-xl shadow-md hover:scale-105 transition flex items-center gap-2"
          >
            {showForm ? "Hide Form" : "Get New Suggestion"}
          </button>
        </div>

        {/* Conditional form or categories + stats */}
        {showForm && user ? (
